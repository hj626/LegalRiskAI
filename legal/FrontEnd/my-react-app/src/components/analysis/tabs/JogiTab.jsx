    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setResult({
                    summary: `사건 종류: ${data.case_type}\n승소율: ${data.win_rate}%\n예상 형량: ${data.sentence}\n예상 벌금: ${data.fine.toLocaleString()}원`,
                overallRisk: data.risk >= 70 ? "높음" : data.risk >= 40 ? "중간" : "낮음",
                feedback: data.feedback,
                classification: { inferred_type: data.case_type, confidence: 1.0 }
            });
